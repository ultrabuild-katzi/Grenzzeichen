...
public class TrackploughItem extends BlockItem implements Equipment {
    private static final UUID ATTRIBUTE_UUID = UUID.fromString("bb8421be-af03-4e47-b143-8ac1f86c4907");
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public TrackploughItem(Block trackPlough, Settings settings) {
        super(trackPlough,settings);
